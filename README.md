...
![Fractais gerados, considerando: a) clássico. b) $\frac{1}{\varphi}$ distância. c)  $\frac{1}{\pi}$ distância. d) 2 distâncias. e) Métrica da Soma. f) Métrica do Máximo. Fonte: Autoria Própria.](results.png)
